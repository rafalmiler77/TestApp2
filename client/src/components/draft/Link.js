    ...
    return (
      <div style={styles.root}>
        ...
        <input
          ...
          value="Log State"
        />
        <button className="btn btn-primary" onClick={()=>this.handleSaveRaw(raw)}>Save as raw</button>
...
export default connect(mapStateToProps, mapDispatchToProps)(LinkEditorExample)
